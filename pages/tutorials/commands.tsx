...
const Invite: NextPage = () => {
  return <>
    ...
    <h1>指令清單與一般指令</h1>
      <h2>指令清單</h2>
      當你成功<Link href="/tutorials/invite">邀請 HiZollo</Link> 參與你的派對後，下一步便是開始使用了。<br />
      ...
      這個指令清單上列著 HiZollo 全部的指令，你也可以在<Link href="/commands">指令列表</Link>這頁上查看所有指令更詳細的用法。<br />
      ...
      會在下一節的「<Link href="/tutorials/command-help">指令用法的查詢</Link>」中說明。<br />
